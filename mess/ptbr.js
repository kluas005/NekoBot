...
exports.premium = (prefix, pushName) => {
	return `[❗]𝗣𝗘𝗗𝗜𝗗𝗢 𝗔𝗣𝗘𝗡𝗔𝗦 𝗣𝗔𝗥𝗔 𝗣𝗥𝗘𝗠𝗜𝗨𝗠[❗] ${pushName} 𝙋𝙖𝙧𝙖 𝙨𝙚 𝙩𝙤𝙧𝙣𝙖𝙧 𝙥𝙧𝙚𝙢𝙞𝙪𝙢, 𝙪𝙨𝙚 ${prefix}𝙫𝙞𝙥 𝙤𝙪 𝙪𝙨𝙚 ${prefix}𝙤𝙬𝙣𝙚𝙧 𝙥𝙖𝙧𝙖 𝙛𝙖𝙡𝙖𝙧 𝙘𝙤𝙢 𝙤 𝙙𝙤𝙣𝙤`
}
